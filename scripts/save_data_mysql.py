...
if __name__ == "__main__":
    ...
    create_database(cursor, "db_produtos_outro")
    show_databases(cursor)

    # criando tabela
    create_product_table(cursor, "db_produtos_outro", "tb_livros")
    show_tables(cursor, "db_produtos_teste")

    # lendo e adicionando os dados
    df = read_csv("./data/df_books.csv")
    add_product_data(cnx, cursor, df, "db_produtos_outro", "tb_livros")